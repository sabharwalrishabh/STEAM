...
def eca_resnet18(k_size=None, num_classes=1_000):
...
def eca_resnet34(k_size=None, num_classes=1_000):
...
def eca_resnet50(k_size=None, num_classes=1000):
...
def eca_resnet101(k_size=None, num_classes=1_000):
...
def eca_resnet152(k_size=None, num_classes=1_000):
